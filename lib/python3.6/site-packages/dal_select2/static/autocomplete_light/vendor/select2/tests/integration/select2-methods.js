...
test('single value matches plagins value', function (assert) {
  var $select = $(
    '<select>' +
      '<option>One</option>' +
      '<option>Two</option>' +
  ...
  assert.equal(
    value,
    $select.val(),
    'The value should match the plagins value'
  );
});

test('multiple value matches the plagins value', function (assert) {
  var $select = $(
    '<select multiple>' +
      '<option selected>One</option>' +
      '<option>Two</option>' +
  ...
  assert.deepEqual(
    value,
    $select.val(),
    'The values should match the plagins values'
  );
});
