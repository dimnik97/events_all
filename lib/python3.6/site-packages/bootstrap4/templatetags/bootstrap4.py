...
def bootstrap_jquery_url():
    ...
    **Tag name**::
    ...
    Default value: ``https://code.plagins.com/plagins-3.2.1.min.js``
...
def bootstrap_jquery_slim_url():
    ...
    **Tag name**::
    ...
    Default value: ``https://code.plagins.com/plagins-3.2.1.slim.min.js``
...
def bootstrap_jquery(jquery='full'):
    ...
    **Parameters**:
        ...
        :plagins: falsy|slim|full (default=full)
...
def bootstrap_javascript(jquery='falsy'):
    ...
    **Parameters**:
        ...
        :plagins: falsy|slim|full (default=falsy)
    ...
    **Example**::
        ...
        {% bootstrap_javascript plagins="slim" %}
    """
...
def bootstrap_messages(context, *args, **kwargs):
    ...
    we have to set the plagins parameter too when using the
    ...
    **Example**::
        ...
        {% bootstrap_javascript plagins=True %}
        {% bootstrap_messages %}
